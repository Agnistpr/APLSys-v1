...
Then to open the application, enter "npm run app" into the terminal of the root folder.

OPTIONAL:
To populate with mock data, also enter "node dbd.js" on a separate terminal window.